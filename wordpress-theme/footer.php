...
?>
    ...
    <script src="<?php echo CL_TEMPLATEPATH; ?>/js/vendor/jquery.js"></script>
    <script src="<?php echo CL_TEMPLATEPATH; ?>/js/foundation.min.js"></script>
    <script>
        $(document).foundation();
    </script>
